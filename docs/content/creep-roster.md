...
|----|--------|------|----|-------|-------|----|------|----------|--------|
| `grub` | Grub | swarm | 30 | 55 | 0 | 0 | 4 | 1 | playable |
| `runner` | Runner | fast | 45 | 100 | 0 | 0 | 5 | 1 | playable |
| `brute` | Brute | tank, armored | 180 | 38 | 20 | 0 | 12 | 3 | playable |
| `shade` | Shade | magic-resist | 90 | 50 | 0 | 30 | 8 | 2 | playable |
| `boss_1` | Boss | boss | 800 | 28 | 40 | 20 | 80 | 10 | playable |

> Velocidades en px/s. Solo `runner` es claramente rápido; el resto va más pausado para leer maze craft.
>
